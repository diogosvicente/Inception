...
echo "DOMAIN_NAME=dioda-si.42.fr" > project/srcs/.env
echo "CERT_=./requirements/tools/dioda-si.42.fr.crt" >> project/srcs/.env
echo "KEY_=./requirements/tools/dioda-si.42.fr.key" >> project/srcs/.env
